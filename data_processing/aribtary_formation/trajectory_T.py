...
# -*- coding: utf-8 -*-
"""
Created on Tue Oct 23 16:16:07 2018
...
permutation_I=[3,1,0,2]
permutation_T1=[2,0,3,1]
permutation_T2=[0,3,2,1]
permutation_T3=[3,0,2,1]


permutation=permutation_T3

data=open('./T_2/log.txt').read().splitlines()
formation=np.array(formation_T)
...
print("formation_center",formation)
