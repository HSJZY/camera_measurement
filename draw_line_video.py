...
def draw_H(img):
    ...
    global marker_4
    try:
        draw_line_two_points(img,marker_1.center,marker_4.center)
        draw_line_two_points(img,marker_3.center,marker_2.center)
        center_14=calc_middle_two_points(marker_1.center,marker_4.center)
        center_32=calc_middle_two_points(marker_3.center,marker_2.center)
        print("center_32:",center_32,"center_14:",center_14,'marker_1.center:',marker_1.center)
        draw_line_two_points(img,center_14,center_32)
    except:
        return img
    return img
def draw_T(img,type_shape):
    global marker_1
    global marker_2
    global marker_3
    global marker_4
    try:
        if type_shape==0:
            draw_line_two_points(img,marker_1.center,marker_3.center)
            draw_line_two_points(img,marker_1.center,marker_4.center)
            draw_line_two_points(img,marker_1.center,marker_2.center)
        elif type_shape==1:
            draw_line_two_points(img,marker_4.center,marker_1.center)
            draw_line_two_points(img,marker_4.center,marker_2.center)
            draw_line_two_points(img,marker_4.center,marker_3.center)
    except:
        return
def draw_Line(img):
    try:
        draw_line_two_points(img,marker_1.center,marker_4.center)
        draw_line_two_points(img,marker_2.center,marker_4.center)
        draw_line_two_points(img,marker_3.center,marker_2.center)
    except:
        return
def draw_I(img):
